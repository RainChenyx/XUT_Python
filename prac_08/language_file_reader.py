...
def main():
    ...
    for line in in_file:
        ...
        if len(parts) >= 5:
            ...
            # pointer is also stored as a string (Yes/No) and we want a Boolean
            pointer_arithmetic = parts[4] == "Yes"
            print(pointer_arithmetic)
            ...
            print(f"Warning: Incomplete data in line '{line.strip()}', skipping this line.")
